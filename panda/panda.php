...
<html>
<head>
    <title> صفحه لاگین شدن فرم پاندا </title>
    <!--Google Font-->
...
<body>
<div class="pahfs" style="margin-right: auto !important; width: 25%; margin-left: auto !important;">
    <div class="login">
        ...
        <button type="button"> وارد شو </button>
...
<script>
  alert("سلام. اصلا نگران نباشید. وقتی بخواین پسوردتون رو وارد کنید، پاندا چشمشو میبنده 😅😅")
